...
- Successfully modeled staffing need for fortune 100 company using cutting edge modeling.
- Streamlined staffing efficiency using latest techniques to process large amounts of claims data.
...
- Summarized highly technical models into potent and interactive media, including HTML presentations/dashboards, Tableau dashboards, and Excel spreadsheets, per business leaders' preferences.
- Improved company best practices by being an early adopter and advocate for Git.
