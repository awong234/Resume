...
- Modeled claims adjuster productivity using zero-inflated negative binomial GLM using package `pscl` as well as non-linear mixed-effects modeling with package `brms`, developing theory for an alternative staffing criterion.
...
* **Cornell University**, Ithaca, NY
    ...
    * Thesis: [Sampling Strategies for Estimating Abundance of Moose (*Alces alces*) and Other Rare Species](https://drive.google.com/file/d/18yUIGAyi5ypOhyEOd3BlsLt-20M1R2LC/view)
